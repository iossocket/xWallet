...
enum ERC20TokenList {
    ...
    static let starknetMainnetTokens: [ERC20Token] = [
        ERC20Token(
            chainId: "SN_MAIN",
            address: Starknet.Token.STRK.hexString,
            symbol: "STRK",
            decimals: 18,
            name: "STRK"
        ),
        ERC20Token(
            chainId: "SN_MAIN",
            address: Starknet.Token.ETH.hexString,
            symbol: "ETH",
            decimals: 18,
            name: "ETH"
        )
    ...
    static let starknetSepoliaTokens: [ERC20Token] = [
        ERC20Token(
            chainId: "SN_SEPOLIA",
            address: Starknet.Token.STRK.hexString,
            symbol: "STRK",
    ...
    static func tokens(for chainId: String) -> [ERC20Token] {
        switch chainId {
        case "11155111":
        ...
        case "SN_MAIN":
            return starknetMainnetTokens
        case "SN_SEPOLIA":
            return starknetSepoliaTokens
        default:
            return []
        }
    }
    ...
    static func token(address: String, chainId: String) -> ERC20Token? {
